...
source /inspire/hdd/project/qproject-fundationmodel/public/sunjie/slime_env_pkgs/slime/scripts/models/qwen3-4B.sh

CKPT_ARGS=(
   --hf-checkpoint /inspire/hdd/project/qproject-fundationmodel/public/sunjie/workspace/LLMs/Qwen3-4B
   --ref-load /inspire/hdd/project/qproject-fundationmodel/public/sunjie/sft/ckpts/Qwen3-4B-Megatron
   --save ${output_path}
   --save-interval 1000
   --no-save-optim
   --no-save-rng
