...
source /inspire/hdd/project/qproject-fundationmodel/public/sunjie/slime_env_pkgs/slime/scripts/models/qwen3-8B.sh

CKPT_ARGS=(
   --hf-checkpoint /inspire/hdd/project/qproject-fundationmodel/public/sunjie/workspace/LLMs/Qwen3-8B
   --ref-load /inspire/hdd/project/qproject-fundationmodel/public/sunjie/sft/ckpts/Qwen3-8B-Megatron
   --save ${output_path}
   --save-interval 1000
   --no-save-optim
   --no-save-rng
