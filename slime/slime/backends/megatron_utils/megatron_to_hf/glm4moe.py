...
def convert_glm4moe_to_hf(args, name, param):
    ...
    if match:
        ...
        elif rest == "shared_head.head.weight":
            return [(f"model.layers.{layer_idx}.shared_head.head.weight", param)]
        elif rest == "shared_head.norm.weight":
            return [(f"model.layers.{layer_idx}.shared_head.norm.weight", param)]
        elif rest == "layer_embed_tokens.weight":
            return [(f"model.layers.{layer_idx}.embed_tokens.weight", param)]
